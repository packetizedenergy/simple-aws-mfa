...
const durationSeconds = argv['duration-sec'] || argv.D || ONE_HOUR_SEC;

const USAGE = `
usage: simple-aws-mfa <mfa-arn> <mfa-token> [--duration-sec <duration-seconds>] [--profile <aws-profile-name>]

where:
    <mfa-arn>                           is the ARN of the user's MFA device
    <mfa-token>                         is the code generated by the MFA device
    --duration-sec <duration-seconds>   is how long the assumed session should remain valid
